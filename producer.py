...
session = boto3.Session(
    aws_access_key_id='AKIAUZPJUGFABEBH6IMR',
    aws_secret_access_key='Be3JRUcfwn3D8MO0HWWkaM3LMu9729wR9Xcn8Ulm',
...
stream_name = 'codehacks-stream01'
...
if __name__ == "__main__":
    num_records = 1000  # Number of fake student records to generate
